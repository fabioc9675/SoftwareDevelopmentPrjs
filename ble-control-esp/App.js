            ...
            .then((dev) => {
                (async () => {
                    ...
                    const characteristic =
                        await this.getServicesAndCharacteristics(services);
                    console.log(
                    ...
                    service.characteristics().then((c) => {
                        ...
                        if (i === services.length - 1) {
                            ...
                            const dialog = temp.find(
                                (characteristics) =>
                                    characteristics.isWritableWithoutResponse
                            );
                            if (!dialog) {
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.listBox}>
                    <FlatList
                        ...
                        renderItem={(
                            ...
                            <TouchableOpacity
                                onPress={() =>
                                    this.connectBleDevice(item.key, item.dev)
                                } // touchable propertie with on press function
                            >
                ...
                <View style={styles.fotter}>
                    ...
                    <Button
                        title={"Ris 0"}
                        onPress={() =>
                            this.writeMessage("Ris 0", "Ris 0 Writted")
                        }
                    />
                    <Button
                        title={"Ris 1"}
